...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\ApiBundle\\Model\\Acl\\Map\\PermissionTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\ApiBundle\Model\Acl\Base\Permission object.
     */
     ...
     * @return $this|\Tekstove\ApiBundle\Model\Acl\Permission The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tekstove\\ApiBundle\\Model\\Acl\\Permission'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\ApiBundle\Model\Acl\Permission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\ApiBundle\Model\Acl\Permission Clone of current object.
     * @throws PropelException
     */
