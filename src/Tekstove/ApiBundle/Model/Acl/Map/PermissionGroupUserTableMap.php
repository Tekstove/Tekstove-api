...
class PermissionGroupUserTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Tekstove\\ApiBundle\\Model\\Acl\\PermissionGroupUser';
  ...
  array (
     ...
     *
     * @param mixed $value A \Tekstove\ApiBundle\Model\Acl\PermissionGroupUser object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Tekstove\ApiBundle\Model\Acl\PermissionGroupUser) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Tekstove\ApiBundle\Model\Acl\PermissionGroupUser object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\ApiBundle\Model\Acl\PermissionGroupUser) { // it's a model object
