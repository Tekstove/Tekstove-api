...
use Tekstove\ApiBundle\Model\Acl\PermissionQuery;
...
class PermissionTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Tekstove\\ApiBundle\\Model\\Acl\\Permission';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\ApiBundle\Model\Acl\Permission) { // it's a model object
