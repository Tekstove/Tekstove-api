...
abstract class Message implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\ApiBundle\\Model\\Chat\\Map\\MessageTableMap';
    ...
    /**
     * The value for the message_html field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Tekstove\ApiBundle\Model\Chat\Base\Message object.
     */
    ...
    /**
     * Get the [message_html] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MessageTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [message_html] column.
     *
     * @param string $v new value
     * @return $this|\Tekstove\ApiBundle\Model\Chat\Message The current object (for fluent API support)
     */
    public function setMessageHtml($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->message_html !== $v) {
            $this->message_html = $v;
            $this->modifiedColumns[MessageTableMap::COL_MESSAGE_HTML] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MessageTableMap::COL_DATE] = true;
            }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[MessageTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MessageTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = MessageTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_MESSAGE_HTML)) {
            $modifiedColumns[':p' . $index++]  = '`message_html`';
        }
        if ($this->isColumnModified(MessageTableMap::COL_IP)) {
            $modifiedColumns[':p' . $index++]  = '`ip`';
        }
        if ($this->isColumnModified(MessageTableMap::COL_DATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`message`':
                        ...
                        break;
                    case '`message_html`':
                        $stmt->bindValue($identifier, $this->message_html, PDO::PARAM_STR);
                        break;
                    case '`ip`':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\ApiBundle\Model\Chat\Message
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\ApiBundle\Model\Chat\Message The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_MESSAGE_HTML)) {
            $criteria->add(MessageTableMap::COL_MESSAGE_HTML, $this->message_html);
        }
        if ($this->isColumnModified(MessageTableMap::COL_IP)) {
            $criteria->add(MessageTableMap::COL_IP, $this->ip);
        }
        if ($this->isColumnModified(MessageTableMap::COL_DATE)) {
            $criteria->add(MessageTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(MessageTableMap::COL_USER_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\ApiBundle\Model\Chat\Message (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\ApiBundle\Model\Chat\Message Clone of current object.
     * @throws PropelException
     */
