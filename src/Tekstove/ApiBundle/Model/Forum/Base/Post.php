...
abstract class Post implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\ApiBundle\\Model\\Forum\\Map\\PostTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\ApiBundle\Model\Forum\Base\Post object.
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\ApiBundle\Model\Forum\Post
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\ApiBundle\Model\Forum\Post The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\ApiBundle\Model\Forum\Post (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\ApiBundle\Model\Forum\Post Clone of current object.
     * @throws PropelException
     */
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('text', new Length(array ('min' => 5,)));
    }
    ...
    public function validate(ValidatorInterface $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            // If validate() method exists, the validate-behavior is configured for related object
            if (method_exists($this->aTopic, 'validate')) {
                if (!$this->aTopic->validate($validator)) {
                    $failureMap->addAll($this->aTopic->getValidationFailures());
                }
            }
