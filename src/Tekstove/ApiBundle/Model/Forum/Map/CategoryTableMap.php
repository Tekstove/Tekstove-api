...
use Tekstove\ApiBundle\Model\Forum\Category;
...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tekstove.ApiBundle.Model.Forum.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Tekstove\\ApiBundle\\Model\\Forum\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tekstove.ApiBundle.Model.Forum.Category';
     ...
     */
    const COL_ID = 'forum_category.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'forum_category.name';

    /**
     * the column name for the order field
     */
    const COL_ORDER = 'forum_category.order';

    /**
     * the column name for the hidden field
     */
    const COL_HIDDEN = 'forum_category.hidden';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Order', 'Hidden', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'order', 'hidden', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_ORDER, CategoryTableMap::COL_HIDDEN, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'order', 'hidden', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Order' => 2, 'Hidden' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'order' => 2, 'hidden' => 3, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_ORDER => 2, CategoryTableMap::COL_HIDDEN => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'order' => 2, 'hidden' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tekstove\\ApiBundle\\Model\\Forum\\Category');
        ...
        $this->addColumn('hidden', 'Hidden', 'INTEGER', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_ORDER);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\ApiBundle\Model\Forum\Category) { // it's a model object
    ...
    /**
     * Deletes all rows from the forum_category table.
     *
     * @param ConnectionInterface $con the connection to use
