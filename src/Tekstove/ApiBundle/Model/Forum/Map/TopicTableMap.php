...
class TopicTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tekstove.ApiBundle.Model.Forum.Map.TopicTableMap';
     ...
     */
    const OM_CLASS = '\\Tekstove\\ApiBundle\\Model\\Forum\\Topic';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tekstove.ApiBundle.Model.Forum.Topic';
     ...
     */
    const COL_NAME = 'forum_topic.name';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'forum_topic.user_id';

    /**
     * the column name for the forum_category_id field
     */
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tekstove\\ApiBundle\\Model\\Forum\\Topic');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Category', '\\Tekstove\\ApiBundle\\Model\\Forum\\Category', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':forum_category_id',
    1 => ':id',
  ...
  array (
    ...
    {
        return array(
            'validate' => array('nameRequired' => array ('column' => 'name','validator' => 'NotBlank',), 'nameMinLength' => array ('column' => 'name','validator' => 'Length','options' => array ('min' => 5,),), ),
        );
    } // getBehaviors()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\ApiBundle\Model\Forum\Topic) { // it's a model object
