...
/**
 * Base class that represents a row from the 'lyric_top_popularity' table.
 *
 *
 *
 * @package    propel.generator.Tekstove.ApiBundle.Model.Lyric.Base
 */
abstract class LyricTopPopularity implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Tekstove\\ApiBundle\\Model\\Lyric\\Map\\LyricTopPopularityTableMap';
    ...
    /**
     * Initializes internal state of Tekstove\ApiBundle\Model\Lyric\Base\LyricTopPopularity object.
     */
    ...
    /**
     * Compares this with another <code>LyricTopPopularity</code> instance.  If
     * <code>obj</code> is an instance of <code>LyricTopPopularity</code>, delegates to
     * <code>equals(LyricTopPopularity)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LyricTopPopularity The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LyricTopPopularityTableMap::COL_ID] = true;
        }
    ...
    public function setLyricId($v)
    {
        ...
        if ($this->lyric_id !== $v) {
            $this->lyric_id = $v;
            $this->modifiedColumns[LyricTopPopularityTableMap::COL_LYRIC_ID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[LyricTopPopularityTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LyricTopPopularityTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLyricTopPopularityQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LyricTopPopularity::setDeleted()
     * @see LyricTopPopularity::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLyricTopPopularityQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LyricTopPopularityTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LyricTopPopularityTableMap::COL_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `lyric_top_popularity` (%s) VALUES (%s)',
    ...
    {
        $pos = LyricTopPopularityTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LyricTopPopularity'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LyricTopPopularity'][$this->hashCode()] = true;
        $keys = LyricTopPopularityTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tekstove\ApiBundle\Model\Lyric\LyricTopPopularity
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tekstove\ApiBundle\Model\Lyric\LyricTopPopularity The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LyricTopPopularityTableMap::COL_ID)) {
            $criteria->add(LyricTopPopularityTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LyricTopPopularityTableMap::COL_LYRIC_ID)) {
    ...
    {
        $criteria = ChildLyricTopPopularityQuery::create();
        $criteria->add(LyricTopPopularityTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tekstove\ApiBundle\Model\Lyric\LyricTopPopularity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tekstove\ApiBundle\Model\Lyric\LyricTopPopularity Clone of current object.
     * @throws PropelException
     */
    ...
    public function getLyric(ConnectionInterface $con = null)
    {
        if ($this->aLyric === null && ($this->lyric_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLyric->addLyricTopPopularities($this);
             */
        }
    ...
    {
        if (null !== $this->aLyric) {
            $this->aLyric->removeLyricTopPopularity($this);
        }
        $this->id = null;
        $this->lyric_id = null;
        $this->date = null;
    ...
    {
        return (string) $this->exportTo(LyricTopPopularityTableMap::DEFAULT_STRING_FORMAT);
    }
