...
class LanguageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Tekstove.ApiBundle.Model.Map.LanguageTableMap';
     ...
     */
    const OM_CLASS = '\\Tekstove\\ApiBundle\\Model\\Language';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Tekstove.ApiBundle.Model.Language';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tekstove\ApiBundle\Model\Language) { // it's a model object
